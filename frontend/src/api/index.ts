...
export const fetchModel = () => json<ModelConfig>("/api/model");
export const saveModel = (patch: Partial<ModelConfig>) =>
  json<{ status: string; config: ModelConfig; note: string }>("/api/model", {
    method: "PUT",
    headers: { "Content-Type": "application/json" },
